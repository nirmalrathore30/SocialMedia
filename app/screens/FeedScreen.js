...
const FeedScreen = ({navigation}) => {
  ...
  const generateDummyPosts = () => {
    return Array.from({length: 200}, (_, index) => ({
      ...
      mediaURL:index ==1? `http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4`:`https://picsum.photos/id/${index % 100}/400/300`,
      mediaType:index ==1?'video': index % 2 === 0 ? 'image' : 'video',
